    ...
    <div class="col-12 sg-offcanvas-mainbar">
      ...
      <div class="profile-header">
        ...
        <div class="profile-buttons-wrapper">
          ...
          {if $user->_logged_in}
            <button class="btn btn-md rounded-pill btn-success" data-toggle="modal" data-url="#send-donation" data-options='{ "handle": "donations", "id": {$donation["page_id"]}, "amount": "{$donation["amount"]}" }'>
              {__("Donate")}
            </button>
          {else}
            <a class="btn btn-md rounded-pill btn-danger" href="{$system['system_url']}/signin">
             {__("Donate")}
            </a>
          {/if}
                ...
                <ul class="about-list">
                  ...
                  <li>
                    <div class="about-list-item">
                      ...
                      {'$'}{$spage['donations']|default:"0"} {__("in donations")}
                    </div>
                  </li>
