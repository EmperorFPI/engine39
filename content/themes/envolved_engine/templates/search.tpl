...
<div class="page-header">
  ...
  <div class="inner">
    <h2>{__("Search")}</h2>
    <p class="text-xlg">{__("Discover new charities, connect, and donate")}</p>
  </div>
</div>
<!-- page header -->
    ...
    <div class="col-12 sg-offcanvas-mainbar">
      ...
      <div class="row">
        ...
        <div class="col-lg-8">
          ...
          <li class="nav-item">
        <a class="nav-link rounded-pill {if $tab == "" || $tab == "pages"}active{/if}" href="{$system['system_url']}/search/{if $query}{$query}/pages{/if}">
          <strong>{__("Pages")}</strong>
        </a>
        </li>  {/if}
          <li class="nav-item">
              <a class="nav-link rounded-pill {if $tab == "posts"}active{/if}" href="{$system['system_url']}/search/{if $hashtag}hashtag/{/if}{if $query}{$query}/posts{/if}">
