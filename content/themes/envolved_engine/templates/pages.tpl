      ...
      <div class="col-sm-9 col-lg-6 mx-sm-auto">
        <form class="js_search-form" data-filter="pages">
          <div class="input-group">
            <input type="text" class="form-control" name="query" placeholder='{__("Search for Charities")}'>
      ...
      <ul>
        ...
        {if $user->_logged_in}
          <li {if $view == "liked"}class="active" {/if}>
            <a href="{$system['system_url']}/pages/liked">{__("Liked Charities")}</a>
          </li>
          <li {if $view == "manage"}class="active" {/if}>
            <a href="{$system['system_url']}/pages/manage">{__("My Charities")}</a>
          </li>
        {/if}
      </ul>
