...
<form class="js_ajax-forms" data-url="posts/funding.php?do=publish">
  <div class="modal-body">
    ...
    <!-- Charity -->
    <div class="form-group">
    <label class="form-label">{__("Charity Fundraising For?")}</label>
    <input name="charity" type="text" class="form-control">
  </div>
    <!-- funding amount -->
    <div class="form-group">
      <label class="form-label">{__("Goal Amount")}</label>
