        ...
        <div class="tab-pane" id="privacy">
          <form class="js_ajax-forms" data-url="admin/users.php?id={$data['user_id']}&do=edit_privacy">
            ...
            <div class="row">
              ...
              <div class="form-group col-md-6">
              <label class="form-label">{__("Who can see your")} {__("donations")}</label>
              <div class="input-group">
                <span class="input-group-text"><i class="fas fa-tips"></i></span>
                <select class="form-control" name="user_privacy_donations">
                  <option {if $data['user_privacy_donations'] == "public"}selected{/if} value="public">
                    {__("Everyone")}
                  </option>
                  <option {if $data['user_privacy_donations'] == "friends"}selected{/if} value="friends">
                    {__("Friends")}
                  </option>
                  <option {if $data['user_privacy_donations'] == "me"}selected{/if} value="me">
                    {__("Just Me")}
                  </option>
                </select>
              </div>
