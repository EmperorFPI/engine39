            ...
            <div class="card">
              <div class="card-body">
                ...
                <ul class="about-list">
                  ...
                  {/if}
{* Adding in the donations to the User Profile Page *}
{*                   {if $profile['user_id'] == $user->_data['user_id'] || $profile['user_privacy_donations'] == "public" || ($profile['user_privacy_donations'] == "friends" && $profile['we_friends'])}
                    <li>
                      <div class="about-list-item">
                        {include file='__svg_icons.tpl' icon="money-bag" class="main-icon" width="24px" height="24px"}
                        {$profile['user_donations']}
                      </div>
                    </li>
                  {/if} *}
                  {if $profile['user_id'] == $user->_data['user_id'] || $profile['user_privacy_donations'] == "public" || ($profile['user_privacy_donations'] == "friends" && $profile['we_friends'])}
