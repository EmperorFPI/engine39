    ...
    <div class="row">
      ...
      <div class="input-group">
        ...
        <select class="form-control" name="user_privacy_donations">
          <option {if $user->_data['user_privacy_donations'] == "public"}selected{/if} value="public">
            {__("Everyone")}
          </option>
          <option {if $user->_data['user_privacy_donations'] == "friends"}selected{/if} value="friends">
            {__("Friends")}
          </option>
          <option {if $user->_data['user_privacy_donations'] == "me"}selected{/if} value="me">
            {__("Just Me")}
          </option>
        </select>
      </div>
