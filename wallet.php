...
try {
  ...
  switch ($_GET['view']) {
    case '':
      ...
      // Changing this to be Donations on Pages-Charities
      if (isset($_GET['wallet_donation_succeed']) && isset($_SESSION['wallet_donation_amount'])) {
        /* assign variables */
        $smarty->assign('wallet_donation_amount', $_SESSION['wallet_donation_amount']);
        /* unset session */
        unset($_SESSION['wallet_donation_amount']);
      }
